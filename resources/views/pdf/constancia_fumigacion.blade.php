    ...
    <div>
        ...
        <div>
            <div style="float:left; width:74%">
                <h6 style="text-align: center;">EN ACATAMIENTO AL ARTICULO 139 FRACC. V Y VI DE LA LEY GENERAL DE SALUD,
                    Y SU
                    APOYO EN ARTICULOS
        ...
        <div style="float:left; padding:30px;">
            <p>Fecha: <b>{{$fumigacion->fechaultimafumigacion}}</b></p>
        </div>
        <div style="float:left;  padding:30px;">
            <p>Vigencia del servicio: <b>30 dias</b></p>
        </div>
        <div style="padding:30px;">
            <p>Proximo servicio: <b>{{$fumigacion->fechaprogramada}}</b></p>
        </div>
        <!-- Tipo de Unidad-->
        <div style="margin-left: 30px;">
            <p>Tipo: <b>{{$fumigacion->unidad}}</b></p>
        </div>
        <!-- Propiedad y Domicilio  -->
        <div style="margin-left: 30px;">
            <p>Propiedad de: <b></b>{{$fumigacion->unidad}}</p>
...
@endforeach
            ...
            <div>
                ...
                <div style="border-style: solid; width:100%; heigth:10%;">
                    <p>{{$fumigacion->observaciones}}</p>
                </div>

                <!-- Método empleado -->
                <p>Método de control empleado: <b>Cebos</b></p>
            </div>
            ...
            <div style="text-align: center">
                ...
                <p style="font-size: 14px;">Calle Noche Buena #20 A. Colonia San Miguel Nopalapa, Epazoyuca Hdo, 43580
                </p>
