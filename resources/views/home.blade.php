            ...
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <div class="card bg-dark order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-users f-left"></i><span>{{ $sin_seguro }}</span></h2>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-primary order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-users f-left"></i><span>{{ $azul }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-success order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-users f-left"></i><span>{{ $verde }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-warning order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-users f-left"></i><span>{{ $amarillo }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-danger order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-users f-left"></i><span>{{ $rojo }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-dark order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-users f-left"></i><span>{{ $expirado }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <h5>VERIFICACIONES AMBIENTALES</h5>
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-dark order-card">
                                        <div class="card-block">
                                            <h5>Unidades sin verificacion</h5>
                                            <h2 class="text-right"><i
                                                    class="fa fa-users f-left"></i><span>{{ $sin_ambiental }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
