...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Verificaciones de Todas Las unidades en {{ $color }}</h3>
        </div>
                                                    ...
                                                    <td>
                                                        @if ($unidade->verificacion == 'Sin Verificación')
                                                            <h5><span class="badge badge-danger"><a class="link-light"
                                                                        href="{{ route('unidades.show', $unidad = $unidade->serieunidad) }}">{{ $unidade->verificacion }}</a></span>
                                                            </h5>
                                                        @else
