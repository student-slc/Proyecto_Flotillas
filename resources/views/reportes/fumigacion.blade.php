...
@section('content')
    <section class="section">
        <div class="section-header">
            @if ($color == 'sin fumigacion')
                @php
                    $estado = 'Sin Fumigacion';
                @endphp
            @endif
            @if ($color == 'azul')
                @php
            ...
            @if ($color == 'expirado')
                @php
                    $estado = 'Fumigacion Expirada';
                @endphp
            @endif
            <h3 class="page__heading">Fumigaciones de Todas Las Unidades Vehiculares y Habitacionales en: {{ $estado }}
            </h3>
        </div>
                            ...
                            <table class="table table-striped mt-2" id="tabla">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($unidades as $unidade)
                                        @if ($opc_2 > $cont)
                                            @if ($calculo[$pos][$cont] == $unidade->serieunidad || $calculo[$pos][$cont] == $unidade->direccion)
                                                @php
                                                    if ($opc_2 == 1) {
                                                        $cont = $cont + 10;
                                                    } else {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($unidade->fumigacion == 'Sin Fumigación')
                                                            <h6><span class="badge badge-danger">Sin <br>Fumigación</span>
                                                            </h6>
                                                        @else
