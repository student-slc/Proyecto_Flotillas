...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Reportes De Verificaciones Físico-Mecánicas</h3>
        </div>
                                    ...
                                    <div class="card bg-dark order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-clipboard-check f-left"></i><span>{{ $sin_ambiental }}</span></h2>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-primary order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-clipboard-check f-left"></i><span>{{ $azul }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-success order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-clipboard-check f-left"></i><span>{{ $verde }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-warning order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-clipboard-check f-left"></i><span>{{ $amarillo }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-danger order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-clipboard-check f-left"></i><span>{{ $rojo }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <div class="card bg-dark order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i
                                                    class="fa fa-clipboard-check f-left"></i><span>{{ $expirado }}</span></h2>
                                            <p class="m-b-0 text-right"><a href="/usuarios" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                    </div>
