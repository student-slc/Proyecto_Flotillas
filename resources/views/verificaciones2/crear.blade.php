...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            @endphp
            <h3 class="page__heading">Verificación Físico-Mecánica para: {{ $unidad }} / {{ $placas }}</h3>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a class="btn btn-danger"
                                href="{{ route('verificacionesfisicomecanicas.show', $unidad) }}">Regresar</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            @endphp
                            <form action="{{ route('verificacionesfisicomecanicas.store') }}"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12" hidden>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tipoverificacion" id="tipoverificacion"
                                                class="form-control" value="Fisica">
                                        </div>
                                    </div>
                                    {{-- ========================================================================= --}}
                                    <div class="col-xs-12 col-sm-12 col-md-12">
