                        ...
                        <table class="table table-striped mt-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <h5><span class="badge badge-dark">{{ $cliente->statuspago }}</span></h5>
                                    @endif
                                    @if ( $cliente->statuspago =='Por Confirmar')
                                    <h5><span class="badge badge-warning">{{ $cliente->statuspago }}</span></h5>
                                    @endif
                                    @if ( $cliente->statuspago =='En Ejecucion')
                                    <h5><span class="badge badge-primary">{{ $cliente->statuspago }}</span></h5>
                                    @endif
                                    @if ( $cliente->statuspago =='No Pagado')
                                    <h5><span class="badge badge-danger">{{ $cliente->statuspago }}</span></h5>
                                    @endif
                                    @if ( $cliente->statuspago =='Pagado')
                                    <h5><span class="badge badge-success">{{ $cliente->statuspago }}</span></h5>
                                    @endif
                                    </td>
                                <td>
